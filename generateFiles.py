            ...
            for i_elem in root:
                if i_elem.tag == 'METADATA':
                    ...
                    try:
                        ...
                        if repoid == 4:
                            text = jsonTree['Study']['recruits']['criteria'] + " " + jsonTree['Disease']['name'] + " " + jsonTree['treatment']['agent'] + " " + jsonTree['treatment']['title'] + " " + jsonTree['Dataset']['briefTitle']  + " " + jsonTree['Dataset']['description']
